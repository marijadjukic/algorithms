...
public class HeapTest {
    ...
    private Heap<Integer> heap = new Heap<>(array);
    ...
    public void testEmptyHeap() {
        Heap<Integer> emptyHeap = new Heap<>();
    ...
    public void testHeapSort() {
        assertArrayEquals(new Integer[]{1,2,3,4,7,8,9,10,14,16},heap.heapSort());
    }

    @Test
    public void testMinHeapProperty() {
        heap.minHeapProperty();
        assertArrayEquals(new Integer[]{1,2,3,4,7,9,10,8,16,14}, heap.toArray());
